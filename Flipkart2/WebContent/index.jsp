...
<body>
			...
			<div class="col-md-8 header">
				...
				<li>
						<a href="#" data-toggle="modal" data-target="#myModal2">
							<span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add Filter </a>
					</li>
				<li>
	...
	<div id="small-dialog1" class="mfp-hide">
		<div class="select-city">
			...
			<form action="ChooseFilterServlet" method="post">
			<select class="list_of_cities"  name="fid">
					...
					for( OmniBean ob : fList ){
						out.println("<option value='" + ob.getFid() + "'>" + ob.getName() + "</option>");
						}
%>				
			</select>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body modal-body-sub_agile">
					...
					<div class="modal_body_left modal_body_left1">
						<h3 class="agileinfo_sign">Add Profile</h3>
						<p>
										...
										<div class="agile_inner_drop_nav_info">
											<div class="col-sm-4 multi-gd-img">
												<ul class="multi-column-dropdown">
													...
													<li>
														<a href="/Flipkart2/DisplayProduct?pro=wbot">Bottom Wear</a>
													</li>
													<li>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			...
			<div class="item item4">
				<div class="container">
				<image style="height:100%, width:100%" src="images/banner2.jpg">
					<div class="carousel-caption">
						<h3>Today
							<span>Discount</span>
						</h3>
