...
<body>
	...
	<div class="ads-grid">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">Women Fashion
			...
			<div class="side-bar col-md-3">
				...
				<div class="left-side">
					...
					<ul>
						...
						<li>
							...
							<span class="span">Forever 21</span>
						...
						<li>
							...
							<span class="span">Dressberry</span>
						...
						<li>
							...
							<span class="span">Vero Moda</span>
				...
				<div class="left-side">
					...
					<h3 class="agileits-sear-head">Color</h3>
			...
			<div class="agileinfo-ads-display col-md-9 w3l-rightpro">
				<div class="wrapper">
                    ...
                    <%!
                    ArrayList<ProductBean> pList;
                    %>

                    <%
                    pList = (ArrayList)request.getAttribute("plist");
                    int i = 0;
                    %>
                    <%
					...
					for( ProductBean pb : pList ){
						if(i % 3 == 0)
							out.println("</tr><tr>");
						out.println("<td><a href='/Flipkart2/ShowProductServlet?pid=" + pb.getPid() + "'>");
						out.println("<div class='product-sec1'><div class='col-xs-4 product-men'><div class='men-pro-item simpleCart_shelfItem'><div class='men-thumb-item'><img src='" + pb.getImage() + "'  style='max-height: 200px;' alt=''>");								
						out.println("</div><div class='item-info-product'><h4>" + pb.getBrand() + " " + pb.getColor() + " " + pb.getType() + "</h4><div class='info-product-price'><span class='item_price'>" + pb.getPrice() + "</span></div>");
